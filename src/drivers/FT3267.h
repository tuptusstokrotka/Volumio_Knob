...
namespace FT3267
{
    ...
    struct Config_t
    {
        ...
        #else
            i2c_port_t i2c_port = TOUCH_I2C_PORT;
        #endif

        #ifndef TOUCH_I2C_ADDR
            uint8_t dev_addr = FT5x06_ADDR;         // Default I2C address
        #else
            uint8_t dev_addr = TOUCH_I2C_ADDR;
        #endif
    };
    ...
    class TP_FT3267
    {
        ...
        public:
            ...
            inline bool init()
            {
                ...
                gpio_set_direction(static_cast<gpio_num_t>(TOUCH_IRQ), GPIO_MODE_INPUT);
                gpio_set_pull_mode(static_cast<gpio_num_t>(TOUCH_IRQ), GPIO_PULLUP_ONLY);
